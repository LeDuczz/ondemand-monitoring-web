...
const AUDIT = [
  {
    actor: 'L. Torres',
    action: 'Modified system config — flight altitude limits',
    time: '09:04',
    type: 'config',
  },
  {
    actor: 'R. Patel',
    action: 'Added new drone DR-GAMMA-3 to fleet registry',
    time: '08:30',
    type: 'fleet',
  },
  {
    actor: 'S. Kim',
    action: 'Approved control handover for MSN-9011',
    time: '08:17',
    type: 'approval',
  },
  {
    actor: 'J. Martinez',
    action: 'Signed in from 192.168.1.44',
    time: '09:12',
    type: 'auth',
  },
  {
    actor: 'A. Chen',
    action: 'Downloaded media package REQ-8830',
                          ...
                          style={{
                            ...
                            background:
                              u.status === 'active'
                                ? 'var(--green-bg)'
                                : 'var(--surface-2)',
                            border: `1px solid ${u.status === 'active' ? 'var(--green-border)' : 'var(--border)'}`,
                            padding: '2px 8px',
                            borderRadius: 4,
                          }}
                        >
